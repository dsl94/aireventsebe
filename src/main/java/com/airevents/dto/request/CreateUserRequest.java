...
@NoArgsConstructor
@AllArgsConstructor
public class CreateUserRequest implements Validate {
    ...
    public void validate() {
        ...
        if (StringUtils.isBlank(this.email)) {
            throw new RcnException(ErrorCode.BAD_REQUEST, "Email je obavezan");
        }
        if (StringUtils.isBlank(this.password)) {
            throw new RcnException(ErrorCode.BAD_REQUEST, "Lozinka je obavezna");
        }
    }
}
